...
#warning 把self注册为SDK的delegate
    ...
    [addButton setImage:[ZMUtils imageNamed:@"add.png"] forState:UIControlStateNormal];
...
- (void)setupSubviews
{
    self.tabBar.backgroundImage = [[ZMUtils imageNamed:@"tabbarBackground.png"] stretchableImageWithLeftCapWidth:25 topCapHeight:25];
    self.tabBar.selectionIndicatorImage = [[ZMUtils imageNamed:@"tabbarSelectBg.png"] stretchableImageWithLeftCapWidth:25 topCapHeight:25];
    ...
    _chatListVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"title.conversation", @"Conversations")
                                                           image:nil
                                                             tag:0];
    [_chatListVC.tabBarItem setFinishedSelectedImage:[ZMUtils imageNamed:@"tabbar_chatsHL.png"]
                         withFinishedUnselectedImage:[ZMUtils imageNamed:@"tabbar_chats.png"]];
    ...
    _contactsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"title.addressbook", @"AddressBook")
                                                           image:nil
                                                             tag:1];
    [_contactsVC.tabBarItem setFinishedSelectedImage:[ZMUtils imageNamed:@"tabbar_contactsHL.png"]
                         withFinishedUnselectedImage:[ZMUtils imageNamed:@"tabbar_contacts.png"]];
    ...
    _settingsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"title.setting", @"Setting")
                                                           image:nil
                                                             tag:2];
    [_settingsVC.tabBarItem setFinishedSelectedImage:[ZMUtils imageNamed:@"tabbar_settingHL.png"]
                         withFinishedUnselectedImage:[ZMUtils imageNamed:@"tabbar_setting.png"]];
...
-(void)didReceiveMessage:(EMMessage *)message
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:RECEVICEMSG object:nil];
